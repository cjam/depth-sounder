...
// todo: this should be on the ViewModel instance
...
function ChannelViewModel(data) {
    ...
    this.data = new ko.computed(function(){
        return ko.mapping.toJS(this);
    },this);

    this.data.subscribe(function(data){
        console.log("Channel updated",data);
        emit("update_channel",data);
    });

    //// Push changes back to server
    //this.dirtyFlag.isDirty.subscribe(function(val){
    //    var data = getData()
    //    console.log("Channel updated",data)
    //    this.dirtyFlag.reset(data);
    //    emit('update_channel', data)
    //},this)
}
...
function MixerViewModel(data) {
    ...
    self.data = ko.computed(function () {
        return {isPlaying: self.isPlaying()}
    });
}
